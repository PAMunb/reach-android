...
java -jar ../reach-main/target/reach-analyzer.jar --extract-only -i $APK_FILE -o "extract_only_apk.csv" -t $MOP_JCA_TARGETS
#
#echo "[+] Testing extract-only mode with JAR..."
#java -jar ../reach-main/target/reach-analyzer.jar --extract-only -i $JAR_FILE -o "extract_only_jar.csv" -t $MOP_JCA_TARGETS
#
