...
public class ReachMethod {
	...
	public ReachMethod(SootMethod method) {
	...
	public boolean equals(Object obj) {
		...
		if ((obj == null) || (getClass() != obj.getClass()))
			return false;
		ReachMethod other = (ReachMethod) obj;
	...
	public String toString() {
		return String.format("ReachMethod [methodName=%s, methodSignature=%s, modifiers=%s, reachable=%s, reachesMop=%s, directlyReachesMop=%s, possiblePath=%s, possiblePathToMop=%s]", methodName, methodSignature, modifiers, reachable, reachesMop,
